...
function sendTrackingEvent(targetType, action, title, originItem, hasSearchResults) {
    ...
    if(typeof CUSTOMDIMENSION_PAGETYPE_EVENT_ORIGIN !== 'undefined' && typeof CUSTOMDIMENSION_PAGETITLE_EVENT_ORIGIN !== 'undefined' && typeof originItem === 'object' && 'parent' in originItem && ['Like', 'Unlike', 'Comment', 'Subscribe', 'Unsubscribe', 'Share'].indexOf(action) !== -1){
        try {
