...
var MATOMO_TARGET_ID = '13';
var MATOMO_BASEPATH = 'https://di-tools.t-systems-mms.eu/matomo/'
var MATOMO_TARGET_PHP = MATOMO_BASEPATH + 'matomo.php';
var MATOMO_TARGET_JS = MATOMO_BASEPATH + 'matomo.js';
...
var CUSTOMDIMENSION_PAGETYPE = 1
var CUSTOMDIMENSION_PAGETITLE = 2
var CUSTOMDIMENSION_APPTYPE = 3
var CUSTOMDIMENSION_APPTITLE = 4
var CUSTOMDIMENSION_CONTENTTITLE = 5
var CUSTOMDIMENSION_PAGETYPE_EVENT = 6
var CUSTOMDIMENSION_PAGETITLE_EVENT = 7
var CUSTOMDIMENSION_APPTYPE_EVENT = 8
var CUSTOMDIMENSION_APPTITLE_EVENT = 9
...
var EXCLUDE_TIMELINETRACKINGUSERS = []; //'ian-bold', 'robert-lang'
// do not track at all on these paths
var EXCLUDED_PATHS = ['/admin']; // '/workspaces/', '/admin/'
// track, but do not send custom dimensions on these paths
var EXCLUDED_GROUPINGPATHS = ['/profile','/account']; // '/workspaces/', '/admin/'
// dev/test/prod
var ENV = 'dev';
